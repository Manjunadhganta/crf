  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="relative flex items-center">
        ...
        <button
          onClick={prevSlide}
          className="absolute -left-14 z-10 bg-black/20 backdrop-blur-md p-3 rounded-full shadow hover:bg-white transition"
        >
          <ChevronLeft size={22} />
        </button>
        ...
        <button
          onClick={nextSlide}
          className="absolute -right-14 z-10 bg-black/20 backdrop-blur-md p-3 rounded-full shadow hover:bg-white transition"
        >
          <ChevronRight size={22} />
        </button>
